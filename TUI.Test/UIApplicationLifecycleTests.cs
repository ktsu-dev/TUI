...
/// </summary>
/// <remarks>
/// Separate from <c>UIApplicationTests</c>, which covers the render loop. These are about the
/// shutdown path — the area where ktsu-dev/TUI#110 lived.
/// </remarks>
[TestClass]
public sealed class UIApplicationLifecycleTests
{
	/// <summary>
